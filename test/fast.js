...
describe('mapAttrToDb', function() {
  ...
  it('should guess default types', function() {
    ...
    table.mapAttrToDb(-100.25).should.eql({N: '-100.25'})
    table.mapAttrToDb(new Date('2013-01-01')).should.eql({S: '2013-01-01T00:00:00.000Z'})
    ...
    table.mapAttrToDb([null]).should.eql({S: '[null]'})
  ...
  it('should map explicit dynamodb types', function() {
    ...
    table.mapAttrToDb(100.25, 'id').should.eql({N: '100.25'})
    table.mapAttrToDb(-100.25, 'id').should.eql({N: '-100.25'})
    table.mapAttrToDb(new Date('2013-01-01'), 'id').should.eql({N: '1356998400000'})
  ...
  it('should return undefined for empty values by default', function() {
    ...
    should.strictEqual(table.mapAttrToDb(undefined, 'id'), undefined)
...
describe('mapAttrFromDb', function() {
  ...
  it('should use default mappings', function() {
    ...
    table.mapAttrFromDb({S: '2013-01-01T00:00:00.000Z'}).should.equal('2013-01-01T00:00:00.000Z')
  ...
  it('should map explicit dynamodb types', function() {
    ...
    table.mapAttrFromDb({N: '100.25'}, 'id').should.equal(100.25)
    table.mapAttrFromDb({N: '-100.25'}, 'id').should.equal(-100.25)
